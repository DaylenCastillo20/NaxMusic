...
import { initCotizacionForm } from '../controllers/cotizacion_controller.js';
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (userSession) {
        ...
        if (rol === 'Administrador' || rol === 'Admin') {
            if (menuGestionCotizaciones) menuGestionCotizaciones.style.display = 'flex';
            if (menuPanelAdmin) menuPanelAdmin.style.display = 'flex';
        }
...
async function cargarContenido(opcion) {
    ...
    if (opcion === 'gestion_cotizaciones' && !esUsuarioAdministrador()) {
        mostrarError("Solo los administradores pueden acceder a la gestion de cotizaciones.");
        return;
    }
